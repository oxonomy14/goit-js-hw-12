import{a as p,i,S as g}from"./assets/vendor-YT4DRQk6.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function l(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(t){if(t.ep)return;t.ep=!0;const r=l(t);fetch(t.href,r)}})();const e={form:document.querySelector("#search-form"),searchText:document.querySelector(".search-form-input"),btnSearch:document.querySelector(".search-btn"),imageList:document.querySelector(".image-search-list"),btnLoadMore:document.querySelector(".btn-loadmore"),btnLoaderBox:document.querySelector(".btn-loader-box"),txtLoaderMore:document.querySelector(".btn-loader-box-txt")};async function y(s,o,l){const a="48017224-d7e819cca6d5953c75e1fff02";p.defaults.baseURL="https://pixabay.com";const t=new URLSearchParams({q:s,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:l,page:o});try{const r=await p.get(`/api/?key=${a}&${t}`),n=r.data.total,h=r.data.hits;return n===0&&(i.error({title:"Помилка",message:"❌ Немає зображень за вашим запитом. Спробуйте інше слово!",position:"topCenter",timeout:5e3}),e.btnLoadMore.style.display="none"),{totalImages:n,images:h}}catch{i.error({title:"Помилка",message:"❌ Виникла помилка на сервері. Спробуйте ще раз пізніше!",position:"topCenter",timeout:5e3})}}function f(s){const o=s.map(a=>`<li class="image-search-item" id="gallery-item">
